...
package risingtide.tidehack.utils.player;

import risingtide.tidehack.TideHack;
import risingtide.tidehack.events.game.GameJoinedEvent;
import risingtide.tidehack.mixininterface.IExplosion;
...
import risingtide.tidehack.utils.entity.fakeplayer.FakePlayerEntity;
...
public class DamageUtils {
    ...
    public static void init() {
        TideHack.EVENT_BUS.subscribe(DamageUtils.class);
    }
