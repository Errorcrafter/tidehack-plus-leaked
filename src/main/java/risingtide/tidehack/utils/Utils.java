...
package risingtide.tidehack.utils;
...
import risingtide.tidehack.mixin.ClientPlayNetworkHandlerAccessor;
import risingtide.tidehack.mixin.MinecraftClientAccessor;
import risingtide.tidehack.mixin.MinecraftServerAccessor;
import risingtide.tidehack.mixininterface.IMinecraftClient;
import risingtide.tidehack.systems.modules.Modules;
import risingtide.tidehack.systems.modules.render.BetterTooltips;
import risingtide.tidehack.systems.modules.world.Timer;
import risingtide.tidehack.utils.player.EChestMemory;
import risingtide.tidehack.utils.render.PeekScreen;
import risingtide.tidehack.utils.render.color.Color;
import risingtide.tidehack.utils.world.BlockEntityIterator;
import risingtide.tidehack.utils.world.WorldChunkIterator;
...
public class Utils {
    ...
    public static boolean openContainer(ItemStack itemStack, ItemStack[] contents, boolean pause) {
        if (hasItems(itemStack) || itemStack.getItem() == Items.ENDER_CHEST) {
            ...
            if (pause) TideHack.screenToOpen = new PeekScreen(itemStack, contents);
    ...
    public static String nameToTitle(String name) {
        return Arrays.stream(name.split("-")).map(StringUtils::lowerCase).collect(Collectors.joining(""));
    }
    ...
    public static String getKeyName(int key) {
        switch (key) {
            ...
            default:
                ...
                return StringUtils.lowerCase(keyName);
        }
    }
