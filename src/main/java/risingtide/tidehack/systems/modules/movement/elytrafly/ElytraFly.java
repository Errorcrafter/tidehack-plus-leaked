...
package risingtide.tidehack.systems.modules.movement.elytrafly;
...
import risingtide.tidehack.systems.modules.movement.elytrafly.modes.Packet;
import risingtide.tidehack.systems.modules.movement.elytrafly.modes.Vanilla;
import risingtide.tidehack.systems.modules.player.ChestSwap;
...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        TideHack.EVENT_BUS.subscribe(staticGroundListener);
    }

    protected void disableGroundListener() {
        TideHack.EVENT_BUS.unsubscribe(staticGroundListener);
    }
    ...
    protected void enableInstaDropListener() {
        TideHack.EVENT_BUS.subscribe(staticInstadropListener);
    }

    protected void disableInstaDropListener() {
        TideHack.EVENT_BUS.unsubscribe(staticInstadropListener);
    }
