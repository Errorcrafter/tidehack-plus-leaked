...
public class StashFinder extends Module {
    ...
    private File getJsonFile() {
        return new File(new File(new File(TideHack.FOLDER, "stashes"), Utils.getWorldName()), "stashes.json");
    }

    private File getCsvFile() {
        return new File(new File(new File(TideHack.FOLDER, "stashes"), Utils.getWorldName()), "stashes.csv");
    }
