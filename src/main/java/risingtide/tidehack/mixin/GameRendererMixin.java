...
import risingtide.tidehack.renderer.Renderer3D;
import risingtide.tidehack.systems.modules.Modules;
import risingtide.tidehack.systems.modules.player.LiquidInteract;
import risingtide.tidehack.systems.modules.player.NoMiningTrace;
...
public abstract class GameRendererMixin {
    ...
    private void onRenderWorldTail(CallbackInfo info) {
        TideHack.EVENT_BUS.post(RenderAfterWorldEvent.get());
    }
