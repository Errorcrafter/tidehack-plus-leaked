...
import risingtide.tidehack.systems.profiles.Profile;
    ...
    private static class ProfilesScreen extends WindowTabScreen {
        ...
        private void initWidget() {
            ...
            for (Profile profile : Profiles.get()) {
                ...
                edit.action = () -> Utils.mc.openScreen(new EditProfileScreen(theme, profile, this::initWidget));
            ...
            create.action = () -> Utils.mc.openScreen(new EditProfileScreen(theme, null, this::initWidget));
        }
    }
