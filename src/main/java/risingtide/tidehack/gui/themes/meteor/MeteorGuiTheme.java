...
import risingtide.tidehack.gui.DefaultSettingsWidgetFactory;
...
import risingtide.tidehack.gui.themes.meteor.widgets.*;
import risingtide.tidehack.gui.themes.meteor.widgets.input.WMeteorDropdown;
import risingtide.tidehack.gui.themes.meteor.widgets.input.WMeteorSlider;
import risingtide.tidehack.gui.themes.meteor.widgets.input.WMeteorTextBox;
import risingtide.tidehack.gui.themes.meteor.widgets.pressable.*;
import risingtide.tidehack.gui.themes.meteor.widgets.pressable.*;
import risingtide.tidehack.gui.utils.AlignmentX;
import risingtide.tidehack.gui.utils.CharFilter;
...
import risingtide.tidehack.gui.widgets.input.WSlider;
import risingtide.tidehack.gui.widgets.input.WTextBox;
import risingtide.tidehack.gui.widgets.pressable.*;
...
public class MeteorGuiTheme extends GuiTheme {
    ...
    public final Setting<SettingColor> accentColor = color("accent", "Main color of the GUI.", new SettingColor(85, 172, 238));
    public final Setting<SettingColor> checkboxColor = color("checkbox", "Color of checkbox.", new SettingColor(85, 172, 238));
    ...
    public final Setting<SettingColor> moduleBackground = color(sgBackgroundColors, "module-background", "Color of module background when active.", new SettingColor(85, 172, 238));
